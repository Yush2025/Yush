...
def main():
	...
	for i in range(30):
		time.sleep(0.1)
		sys.stdout.write(f"\r\033[1;32m LOADING...\033[97;1m " + animation[i % len(animation)] +"\x1b[0m ")
		sys.stdout.flush()
	clear()
            ...
            for future in as_completed(future_to_token):
                ...
                try:
                    ...
                    if status_code == 200:
                        ...
                        print(f"     {white}[ACCOUNT UID] {green}{uid}  {yellow} |───────{blue}➤ {red}REACTION SENT {green}SUCCESSFULLY 🟢")
                        print(f"  {green} ᵖʳᵉᵐⁱᵘᵐ ᵗᵒᵒˡˢ ")
...
{lightblue}╭──────────────────────────────────────────────────────────────────────────╮
{lightblue}│                                                                     {lightblue}     │
{lightblue}│ {gh}                 ░██████╗░░█████╗░██╗░░░██╗██╗███╗░░██╗ {lightblue}                 │
{lightblue}│  {gh2}                ██╔════╝░██╔══██╗██║░░░██║██║████╗░██║ {lightblue}                 │
{lightblue}│  {gh3}                ██║░░██╗░███████║╚██╗░██╔╝██║██╔██╗██║{lightblue}                  │
{lightblue}│ {gh4}                 ██║░░╚██╗██╔══██║░╚████╔╝░██║██║╚████║{lightblue}                  │
{lightblue}│  {gh5}                ╚██████╔╝██║░░██║░░╚██╔╝░░██║██║░╚███║{lightblue}                  │
{lightblue}│  {gh6}                ░╚═════╝░╚═╝░░╚═╝░░░╚═╝░░░╚═╝╚═╝░░╚══╝{lightblue}                  │
{lightblue}│                                {green} NOT FOR {hotpink}FREE                    {lightblue}         │
{lightblue}│                  ╭─────────────────────────────────╮                {lightblue}     │
{lightblue}╰──────────────────│{Q2}   D E V E{Q2} L O P {Q3}E R  Y {Q4}U S {Q5}H    {lightblue}│─────────────────────╯

{gh4} ╭────────{C}TOOL INFORMATION{gh4}─────────╮ {gh4}   ╭────────{C}USER INFORMATION{gh4}─────────╮
{gh4} │ {red}•{hotpink} OWNER   : {Q}Gavin Crisanto {gh4}     │   {gh4} │ {red}• {hotpink}STATUS   : {Q}ACTIVE        {gh4}     │
{gh5} │{red} • {hotpink}USES    : {Q}BOOSTING       {gh5}     │ {gh5}   │ {red}• {hotpink}COUNTRY  :{Q} PHILIPPINES    {gh5}    │
 {gh5}│{red} • {hotpink}NETWORK : {Q}ALL NETWORK     {gh5}    │   {gh5} │ {red}• {hotpink}TELEGRAM : {Q}N/A              {gh6}  │
{gh6} │ {red}• {hotpink}VERSION : {Q}7.0      {gh6}           │{gh5}    │ {red}• {hotpink}TOOLS    : {Q}PREMIUM      {gh6}      │
{gh6} ╰─────────────────────────────────╯    ╰─────────────────────────────────╯""")
from datetime import datetime
...
def main():
    ...
    total_account_rpw, total_pages_rpw = count_tokens(rpwaccounts,rpwpages)
    jovan()
    print(f""" {gh4}┏━━━ {red}• {yellow}• {green}• {gh4}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\033[0m""")
    print(f""" {gh5}┃                        {gh2} 𝗔𝗖𝗖𝗢{gh3}𝗨𝗡𝗧 {gh4}𝗦𝗧𝗢𝗥𝗔{gh5}𝗚𝗘 {gh6}𝗢𝗩𝗘𝗥𝗩𝗜𝗘𝗪          {gh5}              ┃""")
    print(f""" {gh6}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ {red}• {yellow}• {green}• {gh6}━━━━┛   
                            {gh}𝗙𝗥𝗔 𝗔𝗖𝗖𝗢𝗨𝗡𝗧 {yellow}: {green}{total_accounts}
                            {gh2}𝗙𝗥𝗔 𝗣𝗔𝗚𝗘𝗦  {yellow} : {green}{total_pages}
                            {gh3}𝗥𝗣𝗪 𝗔𝗖𝗖𝗢𝗨𝗡𝗧{yellow} : {green}{ total_account_rpw}
                            {gh4}𝗥𝗣𝗪 𝗣𝗔𝗚𝗘𝗦 {yellow}  : {green}{total_pages_rpw} """)
                            
    print(f"{C2}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{C4}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓")
    print(f"{C2}┃                                                                         {C4}┃")
    print(f"{C2}┃ {lightblue}  ┏━━━━━━━━━━━━━━━━━━━━━ {blue}𝗧 𝗢 𝗢 𝗟   𝗠 𝗘 𝗡 𝗨{lightblue} ━━━━━━━━━━━━━━━━━━━━━━━━┓{C4}    ┃")
    print(f"{C2}┃  {lightblue} ┃       {green}﹝{lightblue}A/01{green}﹞{Q} ADD ACCOUNT                     {lightblue}                ┃    {C4}┃")
    print(f"{C2}┃  {lightblue} ┃       {green}﹝{lightblue}B/02{green}﹞ {Q}AUTOMATIC REACTION                        {lightblue}      ┃{C4}    ┃")
    print(f"{C2}┃   {lightblue}┃       {green}﹝{lightblue}C/03{green}﹞{Q} AUTOMATIC REACTION REELS         {lightblue}               ┃  {C4}  ┃")
    print(f"{C2}┃  {lightblue} ┃       {green}﹝{lightblue}D/04{green}﹞ {Q}AUTOMATIC REACTION GROUP                {lightblue}        ┃  {C4}  ┃")
    print(f"{C2}┃ {lightblue}  ┃       { green}﹝{lightblue}E/05{green}﹞{Q} AUTOMATIC REACTION [ VIDEO OR PHOTO ]    {lightblue}       ┃   {C4} ┃")
    print(f"{C3}┃  {lightblue} ┃       {green}﹝{lightblue}F/06{green}﹞{Q2} AUTOMATIC FOLLOWERS                   {lightblue}          ┃    {C4}┃")
    print(f"{C3}┃   {lightblue}┃       {green}﹝{lightblue}G/07{green}﹞{Q2} AUTOMATIC REACTION DP/POST        {lightblue}              ┃    {C4}┃")
    print(f"{C3}┃ {lightblue}  ┃       {green}﹝{lightblue}H/08{green}﹞{Q2} AUTOMATIC CUSTOM COMMENT        {lightblue}                ┃   {C4} ┃")
    print(f"{C3}┃ {lightblue}  ┃       {green}﹝{lightblue}I/09{green}﹞{Q2} AUTOMATIC FOLLOW AND LIKE PAGE ONLY       {lightblue}      ┃ {C5}   ┃")
    print(f"{C3}┃ {lightblue}  ┃       {green}﹝{lightblue}J/10{green}﹞{Q3} AUTOMATIC REACT FOR COMMENTS     {lightblue}               ┃ {C5}   ┃")
    print(f"{C4}┃{lightblue}   ┃       {green}﹝{lightblue}K/11{green}﹞{Q3} AUTOMATIC REPLY FOR COMMENTS        {lightblue}            ┃ {C5}   ┃")
    print(f"{C4}┃{lightblue}   ┃       {green}﹝{lightblue}L/12{green}﹞{Q3} AUTOMATIC REACTION POST ( W/CARE )      {lightblue}        ┃ {C5}   ┃")
    print(f"{C4}┃ {lightblue}  ┃       {green}﹝{lightblue}M/13{green}﹞{Q3} AUTOMATIC GROUP JOIN              {lightblue}              ┃ {C5}   ┃")
    print(f"{C4}┃  {lightblue} ┃       {green}﹝{lightblue}N/14{green}﹞{Q3} AUTOMATIC REACTION ON GOING LIVESTREAM    {lightblue}      ┃ {C5}   ┃")
    print(f"{C4}┃ {lightblue}  ┃       {green}﹝{lightblue}O/15{green}﹞{Q4} AUTOMATIC COMMENT ON GOING LIVESTREAM      {lightblue}     ┃  {C6}  ┃")
    print(f"{C4}┃  {lightblue} ┃       {green}﹝{lightblue}P/16{green}﹞{Q4} ACCOUNT REMOVER                         {lightblue}        ┃  {C6}  ┃")
    print(f"{C5}┃  {lightblue} ┃       {green}﹝{lightblue}Q/17{green}﹞{Q4} REMOVED DUPLICATE ACCOUNTS           {lightblue}           ┃   {C6} ┃")
    print(f"{C5}┃ {lightblue}  ┃       {green}﹝{lightblue}R/18{green}﹞ {Q5}LIVE ACCOUNT CHECKER                     {lightblue}       ┃    {C6}┃")
    print(f"{C5}┃{lightblue}   ┃       {green}﹝{lightblue}S/19{green}﹞{Q5} VALIDATES LIVE ACCOUNT TOKEN           {lightblue}         ┃{C6}    ┃")
    print(f"{C5}┃  {lightblue} ┃       {green}﹝{lightblue}T/20{green}﹞ {Q5}AUTOMATIC SHARE BOT FAST SPEED        {lightblue}          ┃   {C6} ┃") 
    print(f"{C5}┃{lightblue}   ┃       {green}﹝{lightblue}U/21{green}﹞ {Q5}AUTOMATIC SHARE WITH NOTIFICATION        {lightblue}       ┃ {C6}   ┃") 
    print(f"{C6}┃ {lightblue}  ┃       {green}﹝{lightblue}V/22{green}﹞{Q6} FOLLOWERS REMOVER                      {lightblue}         ┃   {C6} ┃")
    print(f"{C6}┃ {lightblue}  ┃       {green}﹝{lightblue}W/23{green}﹞{Q6} AUTOMATIC REACTION V2 WITH REACT REMOVER  {lightblue}      ┃{C6}    ┃")
    print(f"{C6}┃ {lightblue}  ┃       {green}﹝{lightblue}X/24{green}﹞ {Q6}UPDATE TOOLS                               {lightblue}     ┃    {C6}┃")
    print(f"{C6}┃ {lightblue}  ┃       {green}﹝{lightblue}Y/25{green}﹞{Q6} AUTOMATIC FOLLOWERS V2.0              {lightblue}          ┃    {C6}┃")
    print(f"{C6}┃ {lightblue}  ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛ {C6}   ┃")
    print(f"{C6}┃                                                                       {blue}  ┃")
    print(f"{C6}┗━━━━┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\033[0m")
    choice = input(f" {C6}    └──> ENTER YOUR CHOICE {green}: ").strip()         
#C:\Users\Dont touch my pc\Desktop\OPENSOURCE\sy.py
    ...
    if choice == '10' or choice == 'J':
        comment_react()
    if choice == '11' or choice == 'K':
        reply()
    if choice == '12' or choice == 'L':
        AutoReact()
    if choice == '13' or choice == 'M':
        perform_group_join()
    if choice == '14' or choice == 'N':
        live_react()  
    if choice == '15' or choice == 'O':
        live_comment()   
    if choice == '16' or choice == 'P':
        clear_text_files()
    if choice == '17' or choice == 'Q':
        remove_duplicates()
    if choice == '18' or choice == 'R':
        fetch_account_info(file_options)
    if choice == '19' or choice == 'S':
        check()
    else:
        print("Invalid choice, exiting.")
    if choice == '20' or choice == 'T':
        main2()
    if choice == '21' or choice == 'U':
        pub()
    if choice == '22' or choice == 'V':
    	remove_facebook_follower()
    if choice == '23' or choice == 'W':
    	AutoReact2() 
    if choice == '24' or choice == 'X':
    	update()
    if choice == '25' or choice == 'Y':
    	follow()
    else:
        print("Invalid choice, exiting.")
