...
{lightblue}╭──────────────────────────────────────────────────────────────────────────╮
{lightblue}│                                                                     {lightblue}     │
{lightblue}│ {hotpink}            ██╗░░░██╗  ██╗  ██████╗░  ██╗░░░██╗  ░██████╗ {lightblue}               │
{lightblue}│  {hotpink}           ██║░░░██║  ██║  ██╔══██╗  ██║░░░██║  ██╔════╝ {lightblue}               │
{lightblue}│  {hotpink}           ╚██╗░██╔╝  ██║  ██████╔╝  ██║░░░██║  ╚█████╗░{lightblue}                │
{lightblue}│ {hotpink}            ░╚████╔╝░  ██║  ██╔══██╗  ██║░░░██║  ░╚═══██╗{lightblue}                │
{lightblue}│  {hotpink}           ░░╚██╔╝░░  ██║  ██║░░██║  ╚██████╔╝  ██████╔╝{lightblue}                │
{lightblue}│  {hotpink}           ░░░╚═╝░░░  ╚═╝  ╚═╝░░╚═╝  ░╚═════╝░  ╚═════╝░{lightblue}                │
{lightblue}│                                {green} NOT FOR {hotpink}FREE                    {blue}         │
{lightblue}│                  ╭─────────────────────────────────╮                {lightblue}     │
{lightblue}╰──────────────────│{C}   D E V E L O P E R  S Y T H E  {lightblue}│─────────────────────╯
 {lightblue}      ╰───────────────────────────────────────────────────────────╯
 ╭────────{C}TOOL INFORMATION{B}─────────╮ {blue}   ╭────────{C}USER INFORMATION{B}─────────╮
 │ {red}•{hotpink} OWNER   : {green}Y U S H         {blue}    │   {blue} │ {red}• {hotpink}STATUS   : {green}ACTIVE        {blue}     │
 │{red} • {hotpink}USES    : {green}BOOSTING       {blue}     │ {blue}   │ {red}• {hotpink}COUNTRY  :{green} PHILIPPINES    {blue}    │
 │{red} • {hotpink}NETWORK : {green}ALL NETWORK     {blue}    │   {blue} │ {red}• {hotpink}TELEGRAM : {green}N/A              {blue}  │
 │ {red}• {hotpink}VERSION : {green}6.0      {blue}           │{blue}    │ {red}• {hotpink}TOOLS    : {green}PAIDED       {blue}      │
 ╰─────────────────────────────────╯    ╰─────────────────────────────────╯""")
purple = "\033[1;35m"
blue = "\033[34m"
green = "\033[1;32m"
...
def main():
    ...
    total_account_rpw, total_pages_rpw = count_tokens(rpwaccounts,rpwpages)
    jovan()
    print(f""" {lightblue}┏━━━{red}• {yellow}• {green}• {lightblue}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\033[0m""")
    print(f""" {lightblue}┃                   {yellow} ACCOUNT AND PAGE OVERVIEWS             {lightblue}              ┃""")
    print(f""" {lightblue}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ {red}• {yellow}• {green}• {lightblue}━━━━┛   
    ...
    print(f"{lightblue}┏━━━━━━━━━━━━━━━━━━━━━━ {yellow}T O O L  S E R V I C E S{lightblue} ━━━━━━━━━━━━━━━━{red} ⬤ {yellow}⬤ {green}⬤ {lightblue}━━━┓")
    print(f"{lightblue}┃  {green}[01] {hotpink} 𝗦𝘁𝗮𝗿𝘁 𝗧𝗼𝗼𝗹𝘀                          {yellow}❏ {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]    {lightblue}    ┃")
    print(f"{lightblue}┃  {green}[02]  {hotpink}𝗔𝗨𝗧𝗢 𝗥𝗘𝗔𝗖𝗧{yellow} 𝗣𝗢𝗦𝗧                      {yellow}❏ {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]    {lightblue}    ┃")
    print(f"{lightblue}┃  {green}[03]  {hotpink}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 {yellow}𝐑𝐄𝐄𝐋𝐒                     {yellow}❏ {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]      {lightblue}  ┃")
    print(f"{lightblue}┃  {green}[04]  {hotpink}𝗔𝗨𝗧𝗢 𝗥𝗘𝗔𝗖𝗧 {yellow}𝗚𝗥𝗢𝗨𝗣 𝗣𝗢𝗦𝗧                {yellow}❏ {green}[ 𝗣𝗔𝗚𝗘 𝗢𝗥 ACCOUNT ]     {lightblue}   ┃")
    print(f"{lightblue}┃  {green}[05]  {hotpink}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓{yellow} [ 𝐕𝐈𝐃𝐄𝐎 𝐎𝐑 𝐏𝐇𝐎𝐓𝐎 ]        {yellow}❏ {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {lightblue}   ┃")
    print(f"{lightblue}┃  {green}[06]  {hotpink}𝐀𝐔𝐓𝐎 {yellow}𝐅𝐎𝐋𝐋𝐎𝐖                          {yellow}❏ {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]       {lightblue} ┃")
    print(f"{lightblue}┃  {green}[07]  {hotpink}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 {yellow}𝐃𝐏/𝐏𝐎𝐒𝐓                   {yellow}❏ {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]    {lightblue}    ┃")
    print(f"{lightblue}┃  {green}[08]  {hotpink}𝐀𝐔𝐓𝐎 {yellow}𝐂𝐎𝐌𝐌𝐄𝐍𝐓𝐒                        {yellow}❏ {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {lightblue}   ┃")
    print(f"{lightblue}┃  {green}[09]  {hotpink}𝐀𝐔𝐓𝐎 {yellow}𝐅𝐎𝐋𝐋𝐎𝐖 & 𝐋𝐈𝐊𝐄 𝐏𝐀𝐆𝐄              {yellow}❏ {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]    {lightblue}    ┃")
    print(f"{lightblue}┃  {green}[10]  {hotpink}𝐀𝐔𝐓𝐎 𝐒𝐇𝐀𝐑𝐄{yellow} [ 𝐕𝐈𝐀 𝐂𝐎𝐎𝐊𝐈𝐄𝐒 ]           {yellow}❏ {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]      {lightblue}  ┃")
    print(f"{lightblue}┃  {green}[11]  {hotpink}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 {yellow}𝐂𝐎𝐌𝐌𝐄𝐍𝐓𝐒                  {yellow}❏ {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {lightblue}   ┃")
    print(f"{lightblue}┃  {green}[12]  {hotpink}𝐀𝐔𝐓𝐎 𝐑𝐄𝐏𝐋𝐘 {yellow}𝐂𝐎𝐌𝐌𝐄𝐍𝐓𝐒                  {yellow}❏ {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {lightblue}   ┃")
    print(f"{lightblue}┃  {green}[13]  {hotpink}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 𝐏𝐎𝐒𝐓 {yellow}( 𝐖/𝐂𝐀𝐑𝐄 )           {yellow}❏ {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {lightblue}   ┃")
    print(f"{lightblue}┃  {green}[14]  {hotpink}𝐀𝐔𝐓𝐎 𝐆𝐑𝐎𝐔𝐏 {yellow}𝐉𝐎𝐈𝐍                      {yellow}❏ {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {lightblue}   ┃")
    print(f"{lightblue}┃  {green}[15]  {hotpink}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 {yellow}𝐋𝐈𝐕𝐄 𝐒𝐓𝐑𝐄𝐀𝐌               {yellow}❏ {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {lightblue}   ┃")
    print(f"{lightblue}┃  {green}[16]  {hotpink}𝐀𝐔𝐓𝐎 𝐂𝐎𝐌𝐌𝐄𝐍𝐓 {yellow}𝐋𝐈𝐕𝐄 𝐒𝐓𝐑𝐄𝐀𝐌             {yellow}❏ {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {lightblue}   ┃")
    print(f"{lightblue}┃  {green}[17]{hotpink}  𝐑𝐄𝐒𝐄𝐓 𝐓𝐎𝐎𝐋𝐒                          {yellow}❏ {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]      {lightblue}  ┃")
    print(f"{lightblue}┃  {green}[18]{hotpink}  𝐀𝐔𝐓𝐎 𝐂𝐑𝐄𝐀𝐓𝐄 {yellow}𝐏𝐀𝐆𝐄                     {yellow}❏ {green}[ 𝐏𝐇𝐈𝐋𝐈𝐏𝐏𝐈𝐍𝐄 𝐍𝐀𝐌𝐄 ]  {lightblue}      ┃")
    print(f"{lightblue}┃  {green}[19] {hotpink} 𝐀𝐔𝐓𝐎 𝐒𝐄𝐓 {yellow}𝐏𝐅𝐎𝐅𝐈𝐋𝐄                     {yellow}❏ {green}[ 𝐑𝐀𝐍𝐃𝐎𝐌 ]             {lightblue}    ┃")
    print(f"{lightblue}┃  {green}[20] {hotpink} 𝐂𝐑𝐄𝐀𝐓𝐄 {yellow}𝐅𝐈𝐋𝐄                          {yellow}❏ {green}[ 𝐑𝐀𝐍𝐃𝐎𝐌 ]            {lightblue}     ┃")
    print(f"{lightblue}┃  {green}[21] {hotpink} 𝐑𝐄𝐌𝐎𝐕𝐄 {yellow}𝐃𝐔𝐏𝐋𝐈𝐂𝐀𝐓𝐄                     {yellow}❏ {green}[ 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 𝐑𝐎𝐌𝐎𝐕𝐄𝐑 ]    {lightblue}    ┃")
    print(f"{lightblue}┃  {green}[22]  {hotpink}𝐀𝐂𝐂𝐎𝐔𝐍𝐓 {yellow}𝐂𝐇𝐄𝐂𝐊𝐄𝐑                      {yellow}❏ {green}[ 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 𝐂𝐇𝐄𝐂𝐊𝐄𝐑 ]  {lightblue}      ┃")
    print(f"{lightblue}┃  {green}[23]  {hotpink}𝐕𝐀𝐋𝐈𝐃𝐀𝐓𝐄 {yellow}𝐓𝐎𝐊𝐄𝐍                       {yellow}❏ {green}[ 𝐓𝐎𝐊𝐄𝐍 ]             {lightblue}     ┃")
    print(f"{lightblue}┃  {green}[24]  {hotpink}𝐑𝐄𝐃𝐄𝐄𝐌 {yellow}𝐀𝐂𝐂𝐎𝐔𝐍𝐓                       {yellow}❏ {green}[ 𝐑𝐄𝐃𝐄𝐌𝐓𝐈𝐎𝐍𝐒 ]      {lightblue}       ┃") 
    print(f"{lightblue}┃  {green}[25]  {hotpink}𝐀𝐔𝐓𝐎 {yellow}𝐒𝐇𝐀𝐑𝐄 𝐕1                        {yellow}❏ {green}[ 𝐅𝐀𝐒𝐓 𝐒𝐏𝐄𝐄𝐃 / 𝐁𝐎𝐓] {lightblue}       ┃") 
    print(f"{lightblue}┃  {green}[26]  {hotpink}𝐀𝐔𝐓𝐎 {yellow}𝐒𝐇𝐀𝐑𝐄 𝐕2                        {yellow}❏ {green}[ 𝐖𝐈𝐓𝐇 𝐍𝐎𝐓𝐈𝐅𝐈𝐂𝐀𝐓𝐈𝐎𝐍 ]{lightblue}      ┃") 
    print(f"{lightblue}┃ {green} [27]  { hotpink}𝐂𝐎𝐎𝐊𝐈𝐄𝐒/𝐓𝐎𝐊𝐄𝐍                        {yellow}❏ {green}[ 𝐆𝐄𝐓𝐓𝐄𝐑 ] {lightblue}                ┃")
    print(f"{lightblue}┃ {green} [28] {hotpink} 𝐅𝐎𝐋𝐋𝐎𝐖𝐄𝐑 {yellow}𝐑𝐄𝐌𝐎𝐕𝐄𝐑                     {yellow}❏ {green}[ 𝐑𝐄𝐌𝐎𝐕𝐄𝐑 ] {lightblue}               ┃")
    print(f"{lightblue}┃ {green} [29] {hotpink} 𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 𝐕2 𝐖𝐈𝐓𝐇 {yellow}𝐑𝐄𝐌𝐎𝐕𝐄𝐑           {yellow}❏ {green}[ 𝐑𝐄𝐌𝐎𝐕𝐄𝐑 ]         {lightblue}       ┃")
    print(f"{lightblue}┃ {green} [30] {hotpink} 𝐓𝐎𝐎𝐋𝐒 𝐔𝐏𝐃𝐀𝐓𝐄                         {yellow}❏ {green}[ 𝐔𝐏𝐃𝐀𝐓𝐈𝐍𝐆 ]         {lightblue}      ┃")
    print(f"{lightblue}┃  {green}[31]  {hotpink}𝐀𝐔𝐓𝐎 {yellow}𝐅𝐎𝐋𝐋𝐎𝐖   V2                     {yellow}❏ {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]       {lightblue} ┃")
    print(f"{lightblue}┗━━━{red} ⬤ {yellow}⬤ {green}⬤ {lightblue}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\033[0m")
    choice = input(f" {yellow} ENTER YOUR CHOICE: ").strip()         
