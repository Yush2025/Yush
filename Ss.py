...
def jovan():
    ...
    print(f"""
       ...
       {BG}                                                             {RW}
       {BG}                                                             {BG}{RW}
       {BG}  {BG1}Uses :{RW} {Z1}BOOSTING TOOLS {BG}     {BG1}Version :{RW} {Z1} 10{BG}                   {RW}
...
def main():
    ...
    print(f"""       {BG}  {Z1} ༺═────────────────{BG1}ACCOUNT OVERVIEWS{RW}{BG}{Z1}───────────────────═༻  {BG}{RW}
       ...
       {BG}                                                             {RW} """)
    print(f"       {BG1}                {Q} Premium {Z1}Tools Main {Q}Menu                     {BG}{RW} ")                   
    print(f"       {BG}                                                             {RW} ")
    print(f"       {BG}                  {BG1} 𝙎𝙃𝘼𝙍𝙀 𝙏𝙊𝙊𝙇𝙎 𝙎𝙀𝙍𝙑𝙄𝘾𝙀𝙎 {RW}{BG}                     {RW} """)
    print(f"       {BG}                                                             {RW} ")
    print(f"       {BG}   {Q}○ {lightblue}1/A {white}𝐀𝐝𝐝 𝐀𝐜𝐜𝐨𝐮𝐧𝐭 {blue}                ◆{Z1} Extraction{RW}{BG}            {RW} ")
    print(f"       {BG}   {Q}○ {lightblue}2/B {white}𝐒𝐭𝐨𝐫𝐞 𝐚𝐜𝐜𝐨𝐮𝐧𝐭 𝐑𝐞𝐦𝐨𝐯𝐞𝐫  {blue}     ◆{Z1} Reset{RW}{BG}                 {RW} ")
    print(f"       {BG}   {Q}○ {lightblue}3/C {white}𝐒𝐡𝐚𝐫𝐞 𝐁𝐨𝐨𝐬𝐭 𝐅𝐚𝐬𝐭 {blue}           ◆{Z1} Page or Account {RW}{BG}      {RW} ")
    print(f"       {BG}   {Q}○ {lightblue}4/D {white}𝐒𝐡𝐚𝐫𝐞 𝐁𝐨𝐨𝐬𝐭 𝐕𝐢𝐚 𝐓𝐨𝐤𝐞𝐧  {blue}     ◆{Z1} Account {RW}{BG}              {RW} ")
    print(f"       {BG}   {Q}○ {lightblue}5/E {white}𝐕𝐚𝐥𝐢𝐝𝐚𝐭𝐞𝐬 𝐀𝐜𝐜𝐨𝐮𝐧𝐭 𝐓𝐨𝐤𝐞𝐧 {blue}    ◆{Z1} Account Token Checker {RW}{BG}{RW} ")
    print(f"       {BG}   {Q}○ {lightblue}6/F {white}𝐂𝐨𝐨𝐤𝐢𝐞𝐬 𝐀𝐧𝐝 𝐓𝐨𝐤𝐞𝐧 𝐆𝐞𝐭𝐭𝐞𝐫 {blue}   ◆{Z1} Live Cookies & Token {RW}{BG} {RW} ")
    print(f"       {BG}                                                             {RW} ")
    print(f"       {BG}              {BG1} 𝐂𝐇𝐎𝐎𝐒𝐄 𝐒𝐀𝐌𝐏𝐋𝐄 1 𝐨𝐫 2 | 𝐀 𝐨𝐫 𝐁 {RW}{BG}                {RW} """)
    print(f"       {BG}                                                             {RW} ")
