...
{Q6}─██████████████─██████──██████─██████──██████─██████──██████████─██████████████─
{Q6}────────────────────────────────────────────────────────────────────────────────
{Q6} ╭────────{gh}TOOL INFORMATION{gh4}─────────╮ {gh4}   ╭────────{gh2}USER INFORMATION{gh4}─────────╮
{Q6} │ {red}•{hotpink} OWNER   : {h}Y U S H         {gh4}    │   {gh4} │ {red}• {hotpink}STATUS   : {h}ACTIVE        {gh4}     │
{Q6} │{red} • {hotpink}USES    : {h}BOOSTING       {gh5}     │ {gh5}   │ {red}• {hotpink}COUNTRY  :{h} PHILIPPINES    {gh5}    │
 {Q6}│{red} • {hotpink}NETWORK : {h}ALL NETWORK     {gh5}    │   {gh5} │ {red}• {hotpink}TELEGRAM : {h}@Girlie_         {gh6}  │
{Q6} │ {red}• {hotpink}VERSION : {h}7.0      {gh6}           │{gh5}    │ {red}• {hotpink}TOOLS    : {h}PREMIUM SHARE{gh6}      │
{Q6} ╰─────────────────────────────────╯    ╰─────────────────────────────────╯""")
purple = "\033[1;35m"
blue = "\033[34m"
green = "\033[1;32m"
