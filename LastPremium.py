...
{lightblue}╭──────────────────────────────────────────────────────────────────────────╮
{lightblue}│                                                                     {lightblue}     │
{lightblue}│ {Q}                  ░██████╗███╗░░░███╗███╗░░░███╗ {lightblue}                        │
{lightblue}│  {Q2}                 ██╔════╝████╗░████║████╗░████║ {lightblue}                        │
{lightblue}│  {Q3}                 ╚█████╗░██╔████╔██║██╔████╔██║{lightblue}                         │
{lightblue}│ {Q4}                  ░╚═══██╗██║╚██╔╝██║██║╚██╔╝██║{lightblue}                         │
{lightblue}│  {Q5}                 ██████╔╝██║░╚═╝░██║██║░╚═╝░██║{lightblue}                         │
{lightblue}│  {Q6}                 ╚═════╝░╚═╝░░░░░╚═╝╚═╝░░░░░╚═╝{lightblue}                         │
{lightblue}│                                {green} NOT FOR {hotpink}FREE                    {lightblue}         │
{lightblue}│                  ╭─────────────────────────────────╮                {lightblue}     │
{lightblue}╰──────────────────│{Q2}   D E V E{Q2} L O P {Q3}E R  V I N      {lightblue}│─────────────────────╯

{gh4} ╭────────{C}TOOL INFORMATION{gh4}─────────╮ {gh4}   ╭────────{C}USER INFORMATION{gh4}─────────╮
{gh4} │ {red}•{hotpink} OWNER   : {Q}VIN            {gh4}     │   {gh4} │ {red}• {hotpink}STATUS   : {Q}ACTIVE        {gh4}     │
{gh5} │{red} • {hotpink}USES    : {Q}BOOSTING       {gh5}     │ {gh5}   │ {red}• {hotpink}COUNTRY  :{Q} PHILIPPINES    {gh5}    │
 {gh5}│{red} • {hotpink}NETWORK : {Q}ALL NETWORK     {gh5}    │   {gh5} │ {red}• {hotpink}TELEGRAM : {Q}SMM              {gh6}  │
